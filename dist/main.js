...
if (cluster_1.default.isPrimary) {
    console.log(`${console_log_enum_1.EConsoleLog.fgWhite}${console_log_enum_1.EConsoleLog.bgBlack}Master process ${process.pid} is running${console_log_enum_1.EConsoleLog.reset}`);
    ...
    const server = http_1.default
        ...
        .listen(3000)
        .on('listening', () => {
        console.log(`${console_log_enum_1.EConsoleLog.fgGreen}Worker process start with ${console_log_enum_1.EConsoleLog.fgBlue}${process.pid}${console_log_enum_1.EConsoleLog.reset}`);
    });
}
